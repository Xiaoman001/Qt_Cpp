...
Addfriend::Addfriend(QPixmap  icon,
...
void Addfriend::on_pushButton_12_clicked()
{
  ui->stackedWidget->setCurrentIndex(ui->stackedWidget->currentIndex() + 1);
  switch (ui->stackedWidget->currentIndex())
  {
    case 0:
      ui->pushButton_11->setText("关闭");
      break;
    case 1:
      ui->pushButton_11->setText("取消");
      break;
    case 2:
      ui->pushButton_11->setText("完成");
...
void Addfriend::on_pushButton_11_clicked()
{
  this->close();
}
