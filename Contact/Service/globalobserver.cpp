...
QList<chatdemo *> Globalobserver::listchat;
...
QList<chatdemo *>Globalobserver::getListchat()
{
  return listchat;
}

void Globalobserver::setListchat(const QList<chatdemo *>& value)
{
  listchat = value;
}
...
QString Globalobserver::getLocalIP()
{
  // 获取本机IPv4地址
